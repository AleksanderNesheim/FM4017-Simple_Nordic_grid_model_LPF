...
def add_slack_generators(n, nordic_slack_bus = 'SE1 16', nordic_slack_name = f"slack_Forsmark"):
    ...
    """n.add("Generator",
            name = nordic_slack_name[1],
            bus = nordic_slack_bus[1],
            p_nom=1e6,
            marginal_cost=200,
            carrier = "slack",
            control = "Slack")"""
    ...
    """n.add("Generator",
            name = nordic_slack_name[2],
            bus = nordic_slack_bus[2],
            p_nom=1e6,
            marginal_cost=200,
            carrier = "slack",
            control = "Slack")"""

    """for b in nordic_slack_bus:
        n.buses.loc[b, "slack"] = True
        n.buses.loc[b, "slack_weight"] = 1.0   # or your distribution"""
